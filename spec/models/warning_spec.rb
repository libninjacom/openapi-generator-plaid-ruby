...
describe OpenapiClient::Warning do
  let(:instance) { OpenapiClient::Warning.new }
  ...
  describe 'test attribute "warning_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["OWNERS_UNAVAILABLE"])

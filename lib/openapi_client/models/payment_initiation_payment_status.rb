...
module OpenapiClient
  class PaymentInitiationPaymentStatus
    ...
    def build_from_hash(value)
      constantValues = PaymentInitiationPaymentStatus.constants.select { |c| PaymentInitiationPaymentStatus::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #PaymentInitiationPaymentStatus" if constantValues.empty?
      value
    end
  end
end

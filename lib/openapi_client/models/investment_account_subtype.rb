...
module OpenapiClient
  class InvestmentAccountSubtype
    ...
    def build_from_hash(value)
      constantValues = InvestmentAccountSubtype.constants.select { |c| InvestmentAccountSubtype::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #InvestmentAccountSubtype" if constantValues.empty?
      value
    end
  end
end
